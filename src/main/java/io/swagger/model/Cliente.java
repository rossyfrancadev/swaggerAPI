...
public class Cliente   {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "777", value = "")
   ...
   * @return titular
  **/
  @ApiModelProperty(example = "Rossywan França", value = "")
   ...
   * @return cpf
  **/
  @ApiModelProperty(example = "11905506759", value = "")
...
@Size(min=11,max=11) 
   ...
   * @return senha
  **/
  @ApiModelProperty(example = "senha12", value = "")
